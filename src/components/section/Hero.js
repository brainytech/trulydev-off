        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-left">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
              <span className="text-primary text-sm font-medium">🚀 Leading Tech Solutions in Ahmedabad</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              ...
              mobile applications, database solutions, and Power BI analytics. 
              Built by experts in Ahmedabad, for businesses worldwide.
            </p>
          ...
          <div className="relative animate-fade-in-right">
            <div className="relative">
              ...
              {/* Floating elements */}
              <div className="absolute -top-6 -left-6 glass-card p-4 rounded-xl floating" style={{ animationDelay: '1s' }}>
                <div className="text-2xl font-bold text-primary">99.9%</div>
                <div className="text-xs text-muted-foreground">Uptime</div>
              </div>
              
              <div className="absolute -bottom-6 -right-6 glass-card p-4 rounded-xl floating" style={{ animationDelay: '2s' }}>
